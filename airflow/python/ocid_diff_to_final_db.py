...
if __name__ == '__main__':
	...
	df_diff=df_diff.filter(col("lat") >= 46.959149).filter(col("lon") >= 5.704355) \
	...
	df_diff.repartition('radio').write.format("parquet").mode("append").option("path", args.hdfs_target_dir) \
